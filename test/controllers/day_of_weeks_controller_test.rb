...
class DayOfWeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create day_of_week' do
    assert_difference('DayOfWeek.count') do
      post day_of_weeks_url, params: {
        day_of_week: {
          dow_cd_id: @day_of_week.dow_cd_id,
          dow_nm: @day_of_week.dow_nm
        }
      }
    end

    assert_redirected_to day_of_week_path(DayOfWeek.last)
  end
  ...
  test 'should update day_of_week' do
    patch day_of_week_url(@day_of_week), params: {
      day_of_week: {
        dow_cd_id: @day_of_week.dow_cd_id,
        dow_nm: @day_of_week.dow_nm
      }
    }
    assert_redirected_to day_of_week_path(@day_of_week)
  end
